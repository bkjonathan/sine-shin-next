...
interface CargoCustomerLabelTemplateProps {
...
export function CargoCustomerLabelTemplate({
  ref,
  shop,
  shipment,
  note,
  ...
  return (
    ...
    >
      {/* ── Header bar ── */}
      <div style={{ background: "linear-gradient(120deg, #0f172a, #1e293b)", padding: "22px 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <span style={{ background: "rgba(255,255,255,0.12)", color: "white", borderRadius: 9999, padding: "5px 14px", fontSize: 11, textTransform: "uppercase", fontWeight: 700, letterSpacing: "0.12em" }}>
          Customer Label
        </span>
      </div>
      ...
      <div style={{ padding: "28px 32px 32px" }}>
        ...
        <p style={{ fontSize: 30, fontWeight: 800, color: "#0f172a", margin: "0 0 14px", lineHeight: 1.15 }}>
          {customer.name ?? "—"}
        </p>
